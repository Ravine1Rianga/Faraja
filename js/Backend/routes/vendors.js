...
router.post('/',      protect, upload.single('photo'), V.createVendor);

// Admin or vendor owner
router.get('/',       protect, V.getVendors);
router.get('/:id',    protect, V.getVendor);
router.put('/:id',    protect, upload.single('photo'), V.updateVendor);
...
router.post('/:vendorId/products',        protect, upload.single('photo'), P.createProduct);
router.put('/:vendorId/products/:id',     protect, upload.single('photo'), P.updateProduct);
